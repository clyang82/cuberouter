# CubeRouter Electron Desktop App

This directory contains the Electron wrapper for CubeRouter, providing a native desktop application with system tray support for Windows, macOS, and Linux.
